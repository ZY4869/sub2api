...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, modelCatalogService, configConfig)
	apiKeyAuthCacheInvalidator := service.ProvideAPIKeyAuthCacheInvalidator(apiKeyService)
	promoService := service.NewPromoService(promoCodeRepository, userRepository, billingCacheService, client, apiKeyAuthCacheInvalidator)
	affiliateRepository := repository.NewAffiliateRepository(client, db)
	affiliateService := service.NewAffiliateService(settingService, affiliateRepository)
	...
	paymentService := service.ProvidePaymentService(paymentRepository, settingService, httpAirwallexClient, subscriptionService, affiliateService, emailService, emailTemplateService, userRepository)
	...
	documentAIHandler := handler.NewDocumentAIHandler(documentAIService)
