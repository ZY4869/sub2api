...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAICodexAppServerClient := service.NewOpenAICodexAppServerClient(configConfig)
	openAICodexResetCreditService := service.NewOpenAICodexResetCreditService(accountRepository, openAICodexAppServerClient, configConfig)
	adminService := service.NewAdminService(userRepository, groupRepository, accountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, privacyClientFactory, client, settingService, subscriptionService, userSubscriptionRepository, affiliateService, openAICodexResetCreditService, configConfig)
	...
	accountUsageService := service.ProvideAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, usageCache, identityCache, openAICodexResetCreditService, tlsFingerprintProfileService)
