...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authService := service.NewAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, affiliateService, subscriptionService)
	...
	accountHandler := handler.ProvideAdminAccountHandler(adminService, oAuthService, openAIOAuthService, copilotOAuthService, kiroOAuthService, geminiOAuthService, antigravityOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, accountModelImportService, accountModelDiagnosticsService, modelRegistryService, opsService)
	...
	openAIOAuthHandler := handler.ProvideOpenAIOAuthHandler(openAIOAuthService, copilotOAuthService, adminService)
	...
	modelCatalogHandler := admin.NewModelCatalogHandler(modelCatalogService, userService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, channelHandler, adminChannelMonitorHandler, channelMonitorTemplateHandler, accountHandler, affiliateHandler, adminDocsHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, kiroOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, adminAPIKeyHandler, modelCatalogHandler, modelRegistryHandler, scheduledTestHandler, tlsFingerprintProfileHandler)
	...
	gatewayHandler := handler.ProvideGatewayHandler(gatewayService, geminiNativeGatewayService, geminiCompatGatewayService, geminiLiveGatewayService, geminiInteractionsGatewayService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, userMessageQueueService, configConfig, settingService, modelRegistryService)
	...
	opsCleanupService := service.ProvideOpsCleanupService(opsRepository, settingRepository, db, redisClient, configConfig)
