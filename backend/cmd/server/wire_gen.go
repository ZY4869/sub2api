...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelCatalogService := service.NewModelCatalogService(settingRepository, adminService, billingService, pricingService, configConfig)
	accountModelImportService := service.NewAccountModelImportService(modelCatalogService, geminiMessagesCompatService, httpUpstream, proxyRepository)
	accountHandler := handler.ProvideAdminAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, accountModelImportService)
	metaHandler := handler.NewMetaHandler(modelCatalogService)
