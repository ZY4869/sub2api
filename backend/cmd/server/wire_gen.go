...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountModelImportService := service.ProvideAccountModelImportService(modelCatalogService, modelRegistryService, geminiMessagesCompatService, openAITokenProvider, httpUpstream, proxyRepository)
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, accountModelImportService, claudeTokenProvider, openAITokenProvider, geminiTokenProvider, antigravityGatewayService, gatewayService, openAIGatewayService, geminiMessagesCompatService, httpUpstream, configConfig)
	...
	openAIGatewayHandler.SetSettingService(settingService)
	...
	soraGatewayHandler.SetSettingService(settingService)
