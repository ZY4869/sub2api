...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, accountModelImportService, openAITokenProvider, geminiTokenProvider, antigravityGatewayService, httpUpstream, configConfig)
