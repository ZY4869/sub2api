...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, accountModelImportService, claudeTokenProvider, openAITokenProvider, geminiTokenProvider, antigravityGatewayService, httpUpstream, configConfig)
