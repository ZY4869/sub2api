...
// QueryMultiGroups queries the multi_groups edge of a APIKey.
func (c *APIKeyClient) QueryMultiGroups(_m *APIKey) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryParentGroup queries the parent_group edge of a CompositeModelRoute.
func (c *CompositeModelRouteClient) QueryParentGroup(_m *CompositeModelRoute) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryTargetGroup queries the target_group edge of a CompositeModelRoute.
func (c *CompositeModelRouteClient) QueryTargetGroup(_m *CompositeModelRoute) *GroupQuery {
	query := (&GroupClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *CompositeModelRouteClient) Hooks() []Hook {
	return c.hooks.CompositeModelRoute
}
...
// QueryAPIKeyLinks queries the api_key_links edge of a Group.
func (c *GroupClient) QueryAPIKeyLinks(_m *Group) *APIKeyQuery {
	query := (&APIKeyClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
