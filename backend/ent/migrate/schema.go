...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "model_display_mode", Type: field.TypeString, Size: 32, Default: "alias_only", SchemaType: map[string]string{"postgres": "varchar(32)"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "last_used_at", Type: field.TypeTime, Nullable: true},
		{Name: "ip_whitelist", Type: field.TypeJSON, Nullable: true},
		{Name: "ip_blacklist", Type: field.TypeJSON, Nullable: true},
		{Name: "image_only_enabled", Type: field.TypeBool, Default: false},
		...
		{Name: "access_time_policy", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		...
		{Name: "usage_5h_by_currency", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "usage_1d", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "usage_1d_by_currency", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "usage_7d", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "usage_7d_by_currency", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	APIKeyGroupsTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{APIKeyGroupsColumns[6], APIKeyGroupsColumns[7]},
		ForeignKeys: []*schema.ForeignKey{
			{
			...
			},
			{
				...
				Columns:    []*schema.Column{APIKeyGroupsColumns[7]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "original_proxy_id", Type: field.TypeInt64, Nullable: true},
		{Name: "original_proxy_name", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "concurrency", Type: field.TypeInt, Default: 3},
		{Name: "load_factor", Type: field.TypeInt, Nullable: true},
		{Name: "priority", Type: field.TypeInt, Default: 50},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "lifecycle_state", Type: field.TypeString, Size: 20, Default: "normal"},
		{Name: "lifecycle_reason_code", Type: field.TypeString, Nullable: true, Size: 100},
		{Name: "lifecycle_reason_message", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "blacklisted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "blacklist_purge_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "error_message", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "last_used_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "auto_pause_on_expired", Type: field.TypeBool, Default: true},
		{Name: "auto_renew_enabled", Type: field.TypeBool, Default: false},
		{Name: "auto_renew_period", Type: field.TypeString, Size: 20, Default: "month"},
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "account_original_proxy_id",
				Unique:  false,
			...
			{
				Name:    "account_blacklist_purge_at",
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[21]},
			},
			{
				Name:    "account_lifecycle_state_blacklist_purge_at",
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[17], AccountsColumns[21]},
			},
			{
	...
	CompositeModelRoutesColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "display_model_id", Type: field.TypeString, Size: 191},
		{Name: "target_model_id", Type: field.TypeString, Size: 191, Default: ""},
		{Name: "priority", Type: field.TypeInt, Default: 50},
	...
	CompositeModelRoutesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "composite_model_routes_groups_parent_group",
				Columns:    []*schema.Column{CompositeModelRoutesColumns[8]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "composite_model_routes_groups_target_group",
		...
		Indexes: []*schema.Index{
			{
				Name:    "compositemodelroute_parent_group_id",
				Unique:  false,
				Columns: []*schema.Column{CompositeModelRoutesColumns[8]},
			},
			{
			...
			{
				Name:    "compositemodelroute_parent_group_id_display_model_id_enabled_priority",
				Unique:  false,
				Columns: []*schema.Column{CompositeModelRoutesColumns[8], CompositeModelRoutesColumns[3], CompositeModelRoutesColumns[6], CompositeModelRoutesColumns[5]},
			},
		},
	}
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "image_protocol_mode", Type: field.TypeString, Size: 20, Default: "inherit"},
		...
		{Name: "gemini_mixed_protocol_enabled", Type: field.TypeBool, Default: false},
		...
		{Name: "visible_model_patterns", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	}
	...
	ProxiesColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "expiry_remind_days", Type: field.TypeInt, Default: 0},
		{Name: "fallback_proxy_id", Type: field.TypeInt64, Nullable: true},
	}
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "billing_currency", Type: field.TypeString, Size: 3, Default: "USD"},
		{Name: "total_cost_usd_equivalent", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "actual_cost_usd_equivalent", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "usd_to_cny_rate", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "fx_rate_date", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "fx_locked_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "billing_exempt_reason", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "thinking_enabled", Type: field.TypeBool, Nullable: true},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "account_rate_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "discount_applied", Type: field.TypeBool, Default: false},
		{Name: "discount_percent", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(5,2)"}},
		{Name: "discount_window_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "discount_window_type", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "discount_completed_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "email_alias", Type: field.TypeString, Size: 255, Default: ""},
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "admin_free_billing", Type: field.TypeBool, Default: false},
		...
		{Name: "global_realtime_countdown_enabled", Type: field.TypeBool, Default: false},
		...
		{Name: "account_today_stats_cycle_mode", Type: field.TypeString, Size: 32, Default: "calendar"},
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "daily_usage_by_currency", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "weekly_usage_by_currency", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "monthly_usage_by_currency", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
