...
func SetupRouter(
	...
	promptAuditAdmin *securityaudit.AdminHandler,
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, adminAuth, apiKeyAuth, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient, promptAudit, promptAuditAdmin, adminSecurity)
...
func registerRoutes(
	...
	routes.RegisterAuthCompatRoutes(r, h)
