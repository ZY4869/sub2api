...
const defaultDocumentAIUploadMaxBytes = int64(50 * 1024 * 1024)
const defaultDocumentAIUpstreamJSONReadMaxBytes = int64(10 * 1024 * 1024)
const defaultDocumentAIResultReadMaxBytes = int64(100 * 1024 * 1024)
...
func setDefaults() {
	...
	viper.SetDefault("server.client_ip.mode", "gin")
	viper.SetDefault("server.client_ip.headers", []string{})
	viper.SetDefault("server.client_ip.xff_hop_index", 0)
	...
	viper.SetDefault("security.url_allowlist.upstream_hosts", []string{"api.openai.com", "api.anthropic.com", "api.kimi.com", "open.bigmodel.cn", "api.minimaxi.com", "generativelanguage.googleapis.com", "cloudcode-pa.googleapis.com", "*.openai.azure.com", "api.deepseek.com", "api.x.ai", "cli-chat-proxy.grok.com", "aiplatform.googleapis.com", "*.aiplatform.googleapis.com"})
	viper.SetDefault("security.url_allowlist.pricing_hosts", []string{"raw.githubusercontent.com"})
	viper.SetDefault("security.url_allowlist.crs_hosts", []string{})
	viper.SetDefault("security.url_allowlist.document_ai_hosts", []string{"paddleocr.aistudio-app.com"})
	viper.SetDefault("security.url_allowlist.private_host_exceptions", []map[string]any{})
	...
	viper.SetDefault("billing.minimum_request_hold_usd", 0.01)
	viper.SetDefault("billing.request_hold_settlement_max_seconds", 30)
	viper.SetDefault("image_batch.worker_interval_seconds", 15)
	viper.SetDefault("image_batch.worker_claim_limit", 4)
	viper.SetDefault("image_batch.submit_timeout_seconds", 60)
	viper.SetDefault("image_batch.poll_timeout_seconds", 30)
	viper.SetDefault("image_batch.download_timeout_seconds", 180)
	viper.SetDefault("image_batch.settlement_retry_limit", 3)
	viper.SetDefault("image_batch.output_cleanup_after_hours", 168)
	viper.SetDefault("image_batch.download_max_bytes", int64(100*1024*1024))
	viper.SetDefault("image_batch.download_concurrency", 2)
	viper.SetDefault("image_batch.vertex_project_id", "")
	viper.SetDefault("image_batch.vertex_location", "")
	viper.SetDefault("image_batch.vertex_gcs_input_uri", "")
	viper.SetDefault("image_batch.vertex_gcs_output_uri_prefix", "")
	viper.SetDefault("image_batch.storage.backend", "db")
	viper.SetDefault("image_batch.storage.endpoint", "")
	viper.SetDefault("image_batch.storage.bucket", "")
	viper.SetDefault("image_batch.storage.prefix", "image-batches")
	viper.SetDefault("image_batch.storage.region", "auto")
	viper.SetDefault("image_batch.storage.force_path_style", false)
	viper.SetDefault("image_batch.storage.access_key_id", "")
	viper.SetDefault("image_batch.storage.secret_access_key", "")
	...
	viper.SetDefault("openai_codex.app_server_bin", "codex")
	viper.SetDefault("openai_codex.app_server_timeout_seconds", 15)
	viper.SetDefault("openai_codex.reset_credits_enabled", true)
	...
	viper.SetDefault("gateway.openai_http2.send_ping_timeout_seconds", 30)
	viper.SetDefault("gateway.openai_http2.ping_timeout_seconds", 15)
	...
	viper.SetDefault("gateway.document_ai_upload_max_bytes", defaultDocumentAIUploadMaxBytes)
	viper.SetDefault("gateway.document_ai_upstream_json_read_max_bytes", defaultDocumentAIUpstreamJSONReadMaxBytes)
	viper.SetDefault("gateway.document_ai_result_read_max_bytes", defaultDocumentAIResultReadMaxBytes)
	...
	viper.SetDefault("grok.oauth.authorize_url", "https://auth.x.ai/oauth2/authorize")
	viper.SetDefault("grok.oauth.device_url", "https://auth.x.ai/oauth2/device/code")
	viper.SetDefault("grok.oauth.token_url", "https://auth.x.ai/oauth2/token")
	viper.SetDefault("grok.oauth.userinfo_url", "https://auth.x.ai/oauth2/userinfo")
	viper.SetDefault("grok.oauth.client_id", "b1a00492-073a-47ea-816f-4c329264a828")
	viper.SetDefault("grok.oauth.scopes", "openid profile email offline_access grok-cli:access api:access conversations:read conversations:write")
	viper.SetDefault("grok.oauth.redirect_uri", "http://127.0.0.1:56121/callback")
	viper.SetDefault("grok.oauth.base_url", "https://cli-chat-proxy.grok.com/v1")
