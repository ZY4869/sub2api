...
func setDefaults() {
	...
	viper.SetDefault("security.url_allowlist.upstream_hosts", []string{"api.openai.com", "api.anthropic.com", "api.kimi.com", "open.bigmodel.cn", "api.minimaxi.com", "generativelanguage.googleapis.com", "cloudcode-pa.googleapis.com", "*.openai.azure.com", "api.deepseek.com", "api.x.ai", "aiplatform.googleapis.com", "*.aiplatform.googleapis.com"})
	...
	viper.SetDefault("grok.oauth.base_url", "https://api.x.ai/v1")
