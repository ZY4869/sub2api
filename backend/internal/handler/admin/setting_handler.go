...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, req UpdateSettingsRequest) []string {
	...
	if before.PaymentSubscriptionUSDToCNYRate != after.PaymentSubscriptionUSDToCNYRate {
		changed = append(changed, "payment_subscription_usd_to_cny_rate")
	}
...
func buildSystemSettingsDTO(settingService *service.SettingService, settings *service.SystemSettings, customMenuItems []dto.CustomMenuItem) dto.SystemSettings {
	...
	return dto.SystemSettings{
		...
		TencentCaptchaCloudSecretID:                            settings.TencentCaptchaCloudSecretID,
		...
		UsageIPGeoEnabled:                                      settings.UsageIPGeoEnabled,
		UsageIPGeoProviderURL:                                  settings.UsageIPGeoProviderURL,
		UsageIPGeoTimeoutMs:                                    settings.UsageIPGeoTimeoutMs,
