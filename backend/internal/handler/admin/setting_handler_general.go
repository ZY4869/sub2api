...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	contentModerationCyberPolicyEnabled := previousSettings.ContentModerationCyberPolicyEnabled
	if req.ContentModerationCyberPolicyEnabled != nil {
		contentModerationCyberPolicyEnabled = *req.ContentModerationCyberPolicyEnabled
	}
	contentModerationCyberCategories := previousSettings.ContentModerationCyberCategories
	if req.ContentModerationCyberCategories != nil {
		contentModerationCyberCategories = service.NormalizeContentModerationCyberCategoryList(*req.ContentModerationCyberCategories)
	}
	...
	paymentSubscriptionUSDToCNYRate := previousSettings.PaymentSubscriptionUSDToCNYRate
	if req.PaymentSubscriptionUSDToCNYRate != nil {
		paymentSubscriptionUSDToCNYRate = *req.PaymentSubscriptionUSDToCNYRate
	}
	if paymentSubscriptionUSDToCNYRate < 0 {
		paymentSubscriptionUSDToCNYRate = 0
	}
	...
	openAIAllowClaudeCodeCodexPlugin := previousSettings.OpenAIAllowClaudeCodeCodexPlugin
	if req.OpenAIAllowClaudeCodeCodexPlugin != nil {
		openAIAllowClaudeCodeCodexPlugin = *req.OpenAIAllowClaudeCodeCodexPlugin
	}
	openAIAllowedCodexClients := previousSettings.OpenAIAllowedCodexClients
	if req.OpenAIAllowedCodexClients != nil {
		openAIAllowedCodexClients = service.NormalizeOpenAIAllowedCodexClients(*req.OpenAIAllowedCodexClients, false)
	}
	...
	defaultAPIKeyModelBindingMode := previousSettings.DefaultAPIKeyModelBindingMode
	if req.DefaultAPIKeyModelBindingMode != nil {
		defaultAPIKeyModelBindingMode = service.NormalizeAPIKeyModelBindingMode(*req.DefaultAPIKeyModelBindingMode)
	}
	...
	settings := &service.SystemSettings{RegistrationEnabled: req.RegistrationEnabled, EmailVerifyEnabled: req.EmailVerifyEnabled, RegistrationEmailSuffixWhitelist: req.RegistrationEmailSuffixWhitelist, PromoCodeEnabled: req.PromoCodeEnabled, PasswordResetEnabled: req.PasswordResetEnabled, FrontendURL: req.FrontendURL, InvitationCodeEnabled: req.InvitationCodeEnabled, TotpEnabled: req.TotpEnabled, PasskeyEnabled: req.PasskeyEnabled, SMTPHost: req.SMTPHost, SMTPPort: req.SMTPPort, SMTPUsername: req.SMTPUsername, SMTPPassword: req.SMTPPassword, SMTPFrom: req.SMTPFrom, SMTPFromName: req.SMTPFromName, SMTPUseTLS: req.SMTPUseTLS, TelegramChatID: req.TelegramChatID, TelegramBotToken: req.TelegramBotToken, TurnstileEnabled: req.TurnstileEnabled, TurnstileSiteKey: req.TurnstileSiteKey, TurnstileSecretKey: req.TurnstileSecretKey, TencentCaptchaEnabled: req.TencentCaptchaEnabled, TencentCaptchaAppID: req.TencentCaptchaAppID, TencentCaptchaAppSecretKey: req.TencentCaptchaAppSecretKey, TencentCaptchaCloudSecretID: req.TencentCaptchaCloudSecretID, TencentCaptchaCloudSecretKey: req.TencentCaptchaCloudSecretKey, AliyunCaptchaEnabled: req.AliyunCaptchaEnabled, AliyunCaptchaSceneID: req.AliyunCaptchaSceneID, AliyunCaptchaPrefix: req.AliyunCaptchaPrefix, AliyunCaptchaRegion: req.AliyunCaptchaRegion, AliyunCaptchaAccessKeyID: req.AliyunCaptchaAccessKeyID, AliyunCaptchaAccessKeySecret: req.AliyunCaptchaAccessKeySecret, LinuxDoConnectEnabled: req.LinuxDoConnectEnabled, LinuxDoConnectClientID: req.LinuxDoConnectClientID, LinuxDoConnectClientSecret: req.LinuxDoConnectClientSecret, LinuxDoConnectRedirectURL: req.LinuxDoConnectRedirectURL, GitHubOAuthEnabled: req.GitHubOAuthEnabled, GitHubOAuthClientID: req.GitHubOAuthClientID, GitHubOAuthClientSecret: req.GitHubOAuthClientSecret, GitHubOAuthRedirectURL: req.GitHubOAuthRedirectURL, GoogleOAuthEnabled: req.GoogleOAuthEnabled, GoogleOAuthClientID: req.GoogleOAuthClientID, GoogleOAuthClientSecret: req.GoogleOAuthClientSecret, GoogleOAuthRedirectURL: req.GoogleOAuthRedirectURL, DingTalkOAuthEnabled: req.DingTalkOAuthEnabled, DingTalkOAuthClientID: req.DingTalkOAuthClientID, DingTalkOAuthClientSecret: req.DingTalkOAuthClientSecret, DingTalkOAuthRedirectURL: req.DingTalkOAuthRedirectURL, ContentModerationEnabled: req.ContentModerationEnabled, ContentModerationProvider: req.ContentModerationProvider, ContentModerationBaseURL: req.ContentModerationBaseURL, ContentModerationAPIKey: req.ContentModerationAPIKey, ContentModerationModel: req.ContentModerationModel, ContentModerationTimeoutMs: req.ContentModerationTimeoutMs, ContentModerationDedupeWindowSeconds: req.ContentModerationDedupeWindowSeconds, ContentModerationFailOpen: func() bool {
		...
		return previousSettings.ClaudeOAuthSystemPromptBlocksEnabled
	}(), ClaudeOAuthSystemPromptBlocks: func() string {
		if req.ClaudeOAuthSystemPromptBlocks != nil {
			return strings.TrimSpace(*req.ClaudeOAuthSystemPromptBlocks)
		}
		return previousSettings.ClaudeOAuthSystemPromptBlocks
	}(), MinClaudeCodeVersion: req.MinClaudeCodeVersion, MaxClaudeCodeVersion: req.MaxClaudeCodeVersion, AllowUngroupedKeyScheduling: req.AllowUngroupedKeyScheduling, BackendModeEnabled: req.BackendModeEnabled, MaintenanceModeEnabled: req.MaintenanceModeEnabled, OpsMonitoringEnabled: func() bool {
	...
	settings.OpenAIAdvancedSchedulerWeightPriority = stringSetting(req.OpenAIAdvancedSchedulerWeightPriority, previousSettings.OpenAIAdvancedSchedulerWeightPriority)
	settings.OpenAIAdvancedSchedulerWeightLoad = stringSetting(req.OpenAIAdvancedSchedulerWeightLoad, previousSettings.OpenAIAdvancedSchedulerWeightLoad)
	settings.OpenAIAdvancedSchedulerWeightQueue = stringSetting(req.OpenAIAdvancedSchedulerWeightQueue, previousSettings.OpenAIAdvancedSchedulerWeightQueue)
	settings.OpenAIAdvancedSchedulerWeightErrorRate = stringSetting(req.OpenAIAdvancedSchedulerWeightErrorRate, previousSettings.OpenAIAdvancedSchedulerWeightErrorRate)
	settings.OpenAIAdvancedSchedulerWeightTTFT = stringSetting(req.OpenAIAdvancedSchedulerWeightTTFT, previousSettings.OpenAIAdvancedSchedulerWeightTTFT)
	settings.OpenAIAdvancedSchedulerWeightQuotaHeadroom = stringSetting(req.OpenAIAdvancedSchedulerWeightQuotaHeadroom, previousSettings.OpenAIAdvancedSchedulerWeightQuotaHeadroom)
	settings.OpenAIAdvancedSchedulerWeightPreviousResponse = stringSetting(req.OpenAIAdvancedSchedulerWeightPreviousResponse, previousSettings.OpenAIAdvancedSchedulerWeightPreviousResponse)
	settings.OpenAIAdvancedSchedulerWeightSessionSticky = stringSetting(req.OpenAIAdvancedSchedulerWeightSessionSticky, previousSettings.OpenAIAdvancedSchedulerWeightSessionSticky)
