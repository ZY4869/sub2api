...
const usageLogSelectColumns = "id, user_id, api_key_id, account_id, request_id, model, requested_model, upstream_model, group_id, subscription_id, input_tokens, output_tokens, cache_creation_tokens, cache_read_tokens, cache_creation_5m_tokens, cache_creation_1h_tokens, input_cost, output_cost, cache_creation_cost, cache_read_cost, total_cost, actual_cost, billing_exempt_reason, rate_multiplier, account_rate_multiplier, billing_type, request_type, status, stream, openai_ws_mode, duration_ms, first_token_ms, user_agent, ip_address, http_status, error_code, error_message, simulated_client, image_count, image_size, media_type, service_tier, reasoning_effort, thinking_enabled, inbound_endpoint, upstream_endpoint, upstream_url, upstream_service, cache_ttl_overridden, created_at"
