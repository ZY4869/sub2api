...
func ProvideGitHubReleaseClient(cfg *config.Config) service.GitHubReleaseClient {
	return NewGitHubReleaseClientWithToken(cfg.Update.ProxyURL, cfg.Security.ProxyFallback.AllowDirectOnError, cfg.Update.GitHubToken)
}
...
func ProvidePricingRemoteClient(cfg *config.Config) service.PricingRemoteClient {
	return NewPricingRemoteClientWithSecurity(
		cfg.Update.ProxyURL,
...
var ProviderSet = wire.NewSet(
	...
	NewChannelMonitorHistoryRepository,
	...
	NewUsageRepairRepository,
	NewDocumentAIJobRepository,
