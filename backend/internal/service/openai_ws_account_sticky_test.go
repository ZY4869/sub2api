...
func TestOpenAIGatewayService_SelectAccountByPreviousResponseID_Hit(t *testing.T) {
	...
	selection, err := svc.SelectAccountByPreviousResponseID(ctx, &groupID, "resp_prev_1", "gpt-5.4", nil)
...
func TestOpenAIGatewayService_SelectAccountByPreviousResponseID_RateLimitedMiss(t *testing.T) {
	...
	selection, err := svc.SelectAccountByPreviousResponseID(ctx, &groupID, "resp_prev_rl", "gpt-5.4", nil)
	require.NoError(t, err)
...
func TestOpenAIGatewayService_SelectAccountByPreviousResponseID_GroupMismatchMiss(t *testing.T) {
	ctx := context.Background()
	groupID := int64(23)
	account := Account{
		ID:          32,
	...
	require.NoError(t, store.BindResponseAccount(ctx, groupID, "resp_prev_group_mismatch", account.ID, time.Hour))

	selection, err := svc.SelectAccountByPreviousResponseID(ctx, &groupID, "resp_prev_group_mismatch", "gpt-5.4", nil)
	require.NoError(t, err)
	require.Nil(t, selection, "previous_response_id should not cross group boundaries")
	boundAccountID, getErr := store.GetResponseAccount(ctx, groupID, "resp_prev_group_mismatch")
	require.NoError(t, getErr)
	require.Zero(t, boundAccountID)
}
...
func TestOpenAIGatewayService_SelectAccountByPreviousResponseID_DBRuntimeRecheckRateLimitedMiss(t *testing.T) {
	...
	selection, err := svc.SelectAccountByPreviousResponseID(ctx, &groupID, "resp_prev_db_rl", "gpt-5.4", nil)
	require.NoError(t, err)
...
func TestOpenAIGatewayService_SelectAccountByPreviousResponseID_Excluded(t *testing.T) {
	...
	selection, err := svc.SelectAccountByPreviousResponseID(ctx, &groupID, "resp_prev_2", "gpt-5.4", map[int64]struct{}{account.ID: {}})
	require.NoError(t, err)
...
func TestOpenAIGatewayService_SelectAccountByPreviousResponseID_ForceHTTPIgnored(t *testing.T) {
	...
	selection, err := svc.SelectAccountByPreviousResponseID(ctx, &groupID, "resp_prev_force_http", "gpt-5.4", nil)
	require.NoError(t, err)
...
func TestOpenAIGatewayService_SelectAccountByPreviousResponseID_BusyKeepsSticky(t *testing.T) {
	...
	selection, err := svc.SelectAccountByPreviousResponseID(ctx, &groupID, "resp_prev_busy", "gpt-5.4", nil)
	require.NoError(t, err)
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
