...
type UsageLogRepository interface {
	...
	GetUserSpendingRanking(ctx context.Context, startTime, endTime time.Time, limit int, requestType *int16, metric string) (*usagestats.UserSpendingRankingResponse, error)
