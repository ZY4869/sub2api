...
func TestLookupProtocolCapability(t *testing.T) {
	tests := []struct {
		...
		{name: "grok compat messages", runtimePlatform: PlatformGrok, inboundEndpoint: EndpointMessages, wantMode: ProtocolCapabilityCompatTranslate, wantOK: true},
		...
		{name: "openai count tokens compat", runtimePlatform: PlatformOpenAI, inboundEndpoint: EndpointMessages, action: ProtocolCapabilityActionCountTokens, wantMode: ProtocolCapabilityCompatTranslate, wantOK: true},
