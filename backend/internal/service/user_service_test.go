...
func TestUpdateProfile_UsageViewPreferences_NormalizesAndPersists(t *testing.T) {
	...
	require.False(t, updated.UsageViewPreferences.Admin.ShowTokenUsageTrend)
	...
	require.True(t, updated.UsageViewPreferences.User.ShowTokenUsageTrend)
...
func TestNormalizeUsageViewPreferences_MapsLegacyTokenDisplayModes(t *testing.T) {
	...
	require.Equal(t, UsageViewTokenDisplayNatural, normalized.Admin.TokenDisplay)
	require.Equal(t, UsageViewTokenDisplayM, normalized.User.TokenDisplay)
}
...
func TestNormalizeUsageViewPreferences_DefaultsAndAllowedColumns(t *testing.T) {
	...
	require.False(t, normalized.Admin.ShowTokenUsageTrend)
	...
	require.False(t, normalized.User.ShowTokenUsageTrend)
