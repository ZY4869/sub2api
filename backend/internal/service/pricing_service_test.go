...
func TestPricingService_Initialize_UsesGemini36FlashOfficialPricing(t *testing.T) {
	...
	require.InDelta(t, 0.75e-6, pricing.InputCostPerToken, 1e-12)
	require.InDelta(t, 3.75e-6, pricing.OutputCostPerToken, 1e-12)
	require.InDelta(t, 0.75e-7, pricing.CacheReadInputTokenCost, 1e-12)
