...
var (
	...
	ErrChannelMonitorInvalidRequest       = infraerrors.BadRequest("CHANNEL_MONITOR_REQUEST_INVALID", "invalid channel monitor request")
	...
	ErrChannelMonitorInvalidOpenAIAPIMode = infraerrors.BadRequest("CHANNEL_MONITOR_OPENAI_API_MODE_INVALID", "invalid OpenAI API mode")
	ErrChannelMonitorInvalidTemplateID    = infraerrors.BadRequest("CHANNEL_MONITOR_TEMPLATE_ID_INVALID", "invalid template id")
)
