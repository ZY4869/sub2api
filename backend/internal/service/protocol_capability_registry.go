...
var publicEndpointRegistry = []PublicEndpointRegistryEntry{
	{
		...
		Capabilities: []PublicProtocolCapability{
			...
			{InboundEndpoint: EndpointMessages, RequestFormat: "/v1/messages/count_tokens", Action: ProtocolCapabilityActionCountTokens, SourceProtocol: PlatformAnthropic, RuntimePlatform: PlatformOpenAI, Mode: ProtocolCapabilityCompatTranslate},
			...
			{InboundEndpoint: EndpointMessages, RequestFormat: "/v1/messages/count_tokens", Action: ProtocolCapabilityActionCountTokens, SourceProtocol: PlatformAnthropic, RuntimePlatform: PlatformGrok, Mode: ProtocolCapabilityCompatTranslate},
			{InboundEndpoint: EndpointMessages, RequestFormat: EndpointMessages, Action: ProtocolCapabilityActionDefault, SourceProtocol: PlatformAnthropic, RuntimePlatform: PlatformGrok, Mode: ProtocolCapabilityCompatTranslate},
		},
	},
	{
	...
	},
	{
		...
		Routes: []PublicEndpointRoute{
			...
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/models"},
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/models/*subpath"},
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/files"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/files"},
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/files/*subpath"},
			{Method: http.MethodDelete, Pattern: "/antigravity/v1beta/openai/files/*subpath"},
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/batches"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/batches"},
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/batches/*subpath"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/batches/*subpath"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/responses"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/responses/*subpath"},
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/responses/*subpath"},
			{Method: http.MethodDelete, Pattern: "/antigravity/v1beta/openai/responses/*subpath"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/chat/completions"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/embeddings"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/images/generations"},
			{Method: http.MethodPost, Pattern: "/antigravity/v1beta/openai/videos"},
			{Method: http.MethodGet, Pattern: "/antigravity/v1beta/openai/videos/*subpath"},
		},
		Capabilities: []PublicProtocolCapability{
			...
			{InboundEndpoint: EndpointGeminiOpenAICompat, RequestFormat: EndpointGeminiOpenAICompat, Action: ProtocolCapabilityActionDefault, SourceProtocol: PlatformGemini, RuntimePlatform: PlatformAntigravity, Mode: ProtocolCapabilityNativePassthrough},
		},
	},
	{
