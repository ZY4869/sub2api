...
type ProtocolNormalizeResult struct {
	...
	ImageRequestSurface                     string   `json:"image_request_surface,omitempty"`
	ImageSizeTier                           string   `json:"image_size_tier,omitempty"`
	ImageCapabilityProfile                  string   `json:"image_capability_profile,omitempty"`
	ImagegenCompat                          bool     `json:"imagegen_compat,omitempty"`
	ImagegenCompatRejected                  bool     `json:"imagegen_compat_rejected,omitempty"`
	ImagegenCompatRejectCode                string   `json:"imagegen_compat_reject_code,omitempty"`
	ImagegenCompatSourceGuess               string   `json:"imagegen_compat_source_guess,omitempty"`
	ImagegenCompatSource                    string   `json:"imagegen_compat_source,omitempty"`
	ImagegenCompatReferenceImageCount       int      `json:"imagegen_compat_reference_image_count,omitempty"`
	ImagegenCompatReferenceImageBytesBefore int64    `json:"imagegen_compat_reference_image_bytes_before,omitempty"`
	ImagegenCompatReferenceImageBytesAfter  int64    `json:"imagegen_compat_reference_image_bytes_after,omitempty"`
	ImagegenCompatNormalized                bool     `json:"imagegen_compat_normalized,omitempty"`
	ImagegenCompatImageGenerationSize       string   `json:"imagegen_compat_image_generation_size,omitempty"`
