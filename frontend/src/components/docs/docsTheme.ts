...
const DOCS_THEMES: Record<DocsPageId, DocsTheme> = {
  ...
  openai: {
    ...
    navActiveClass: 'border-violet-200 bg-violet-50 text-violet-700 dark:border-violet-500/30 dark:bg-violet-500/10 dark:text-violet-200',
    tocActiveClass: 'border-violet-200 bg-violet-50 text-violet-700 dark:border-violet-500/30 dark:bg-violet-500/10 dark:text-violet-200',
  ...
  'document-ai': {
    ...
    navActiveClass: 'border-orange-200 bg-orange-50 text-orange-700 dark:border-orange-500/30 dark:bg-orange-500/10 dark:text-orange-200',
    tocActiveClass: 'border-orange-200 bg-orange-50 text-orange-700 dark:border-orange-500/30 dark:bg-orange-500/10 dark:text-orange-200',
    tabActiveClass: 'bg-orange-600 text-white shadow-sm dark:bg-orange-500',
