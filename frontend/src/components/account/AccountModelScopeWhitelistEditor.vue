<template>
  <div class="space-y-3">
    ...
    <div class="flex flex-wrap items-center gap-3">
      ...
      <label class="flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-2 text-xs text-gray-600 dark:border-dark-600 dark:text-gray-300">
    ...
    <p v-if="viewMode === 'default'" class="text-xs text-gray-500 dark:text-gray-400">
      ...
      <div class="mb-3 flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <div class="text-xs text-gray-500 dark:text-gray-400">
            ...
            <span v-if="viewMode === 'search' && group.truncated" class="ml-2 text-amber-600 dark:text-amber-400">
        ...
        >
          ...
          <div class="min-w-0 flex-1">
            <div class="flex items-center gap-2">
              ...
              <span
                v-if="entry.status && entry.status !== 'stable'"
    ...
    <p class="text-xs text-gray-500 dark:text-gray-400">
      ...
      <span v-if="allowedModels.length === 0">
        ...
        <span class="ml-1">{{ t('admin.accounts.autoPickLatestTestModelHint') }}</span>
      </span>
    </p>
  </div>
</template>
...
const providerAllModelIds = computed(() => whitelistState.value.providerAllModelIds)
