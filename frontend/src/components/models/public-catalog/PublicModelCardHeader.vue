<template>
  <div class="mb-4 flex min-w-0 items-start justify-between gap-3">
    <div class="flex min-w-0 flex-1 items-center gap-3">
      <div class="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-slate-100 bg-slate-50 dark:border-dark-700 dark:bg-dark-800">
      ...
      <div class="min-w-0">
        <h2 class="flex min-w-0 items-center gap-2 text-base font-black leading-tight text-slate-800 dark:text-white 2xl:text-lg">
          <ModelIcon
        ...
        <div class="mt-1 flex min-w-0 flex-wrap items-center gap-2 text-[11px] font-mono text-slate-400">
          <button
            type="button"
            class="group/copy inline-flex min-w-0 max-w-full items-center gap-1.5 transition-colors hover:text-indigo-500"
            :title="copyTitle"
    ...
    <button
      type="button"
      class="flex h-8 shrink-0 items-center gap-1 rounded-lg border border-slate-200/80 px-2.5 text-[11px] font-bold text-slate-500 transition-colors hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-600 dark:border-dark-700 dark:text-slate-300 dark:hover:border-indigo-500/50 dark:hover:bg-indigo-500/10 dark:hover:text-indigo-200 sm:px-3"
      :title="detailTitle"
