...
import BillingPricingIssuesPanel from '../BillingPricingIssuesPanel.vue'
...
describe('BillingPricingIssuesPanel', () => {
  it('renders red and amber issue states with provider rankings', () => {
    const wrapper = mount(BillingPricingIssuesPanel, {
      props: { audit: createAudit() },
      global: {
        stubs: {
          ModelIcon: {
