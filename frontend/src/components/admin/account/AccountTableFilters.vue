...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: t('admin.accounts.platforms.anthropic') }, { value: 'kiro', label: t('admin.accounts.platforms.kiro') }, { value: 'openai', label: t('admin.accounts.platforms.openai') }, { value: 'copilot', label: t('admin.accounts.platforms.copilot') }, { value: 'grok', label: t('admin.accounts.platforms.grok') }, { value: 'protocol_gateway', label: t('admin.accounts.platforms.protocol_gateway') }, { value: 'gemini', label: t('admin.accounts.platforms.gemini') }, { value: 'antigravity', label: t('admin.accounts.platforms.antigravity') }])
