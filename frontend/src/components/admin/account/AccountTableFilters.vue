...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'kiro', label: 'Kiro' }, { value: 'openai', label: 'OpenAI' }, { value: 'copilot', label: 'Copilot' }, { value: 'grok', label: 'Grok' }, { value: 'protocol_gateway', label: t('admin.accounts.platforms.protocol_gateway') }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }, { value: 'sora', label: 'Sora' }])
