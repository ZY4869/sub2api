<template>
  ...
  <svg v-else-if="platform === 'copilot'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M17.533 2.829A2.528 2.528 0 0 0 15.11 1h-.737a2.531 2.531 0 0 0-2.484 2.087l-1.263 6.937.314-1.08a2.528 2.528 0 0 1 2.424-1.833h4.284l1.797.706 1.731-.706h-.505a2.528 2.528 0 0 1-2.423-1.829l-.715-2.453Z" />
    <path d="M6.726 21.16A2.528 2.528 0 0 0 9.152 23h1.566c1.37 0 2.49-1.1 2.525-2.48l.17-6.69-.357 1.228a2.528 2.528 0 0 1-2.423 1.83h-4.32l-1.54-.842-1.667.843h.497c1.124 0 2.113.75 2.426 1.84l.697 2.432Z" />
    <path d="M15 1H6.252c-2.5 0-4 3.331-5 6.662-1.184 3.947-2.734 9.225 1.75 9.225H6.78c1.13 0 2.12-.753 2.43-1.847.657-2.317 1.809-6.359 2.713-9.436.46-1.563.842-2.906 1.43-3.742A1.97 1.97 0 0 1 15 1Z" />
    <path d="M9 23h8.749c2.5 0 4-3.332 5-6.663 1.184-3.948 2.734-9.227-1.75-9.227H17.22c-1.129 0-2.12.754-2.43 1.848a1149.2 1149.2 0 0 1-2.713 9.437c-.46 1.564-.842 2.907-1.43 3.743A1.97 1.97 0 0 1 9 23Z" />
  </svg>
  <!-- Grok / xAI logo -->
  <svg v-else-if="platform === 'grok'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M5.2 3h3.62l3.18 4.73L15.2 3H18.8l-5 7.32L19.3 21h-3.63L12 15.42 8.33 21H4.7l5.5-10.68L5.2 3z" />
  </svg>
