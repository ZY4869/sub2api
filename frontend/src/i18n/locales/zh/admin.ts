  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        archiveCurrentGroup: '归档当前分组',
        archiveCurrentGroupTitle: '归档当前分组',
        archiveCurrentGroupDescription: '会将当前分组 {group} 下的全部账号归档到归档组，并从主账号页折叠隐藏，不受分页和勾选影响。',
        archiveCurrentGroupDisabled: '请先在筛选条件里选择一个具体分组',
        archiveCurrentGroupSuccess: '已将分组 {group} 下的 {count} 个账号归档到 {archive}',
