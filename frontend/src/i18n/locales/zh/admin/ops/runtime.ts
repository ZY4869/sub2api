export default {
    runtime: {
        ...
        metricThresholdsHint: "用于判断界面指标是否需要高亮提醒。",
        slaMinPercent: "SLA 最低值（%）",
        slaMinPercentHint: "低于该值时标记为风险。",
        ttftP99MaxMs: "TTFT P99 最大值（毫秒）",
        ttftP99MaxMsHint: "高于该值时标记为风险。",
        requestErrorRateMaxPercent: "请求错误率最大值（%）",
        requestErrorRateMaxPercentHint: "高于该值时标记为风险。",
        upstreamErrorRateMaxPercent: "上游错误率最大值（%）",
        upstreamErrorRateMaxPercentHint: "高于该值时标记为风险。",
        silencing: {
            title: "告警静默（维护模式）",
            enabled: "启用静默",
