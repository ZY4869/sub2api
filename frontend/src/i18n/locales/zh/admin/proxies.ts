export default {
    ...
    status: "状态",
    expiresAt: "有效期",
    expiresAtHint: "留空表示长期有效，提交后按 UTC 保存。",
    expiryRemindDays: "提前提醒天数",
    expiryRemindDaysHint: "0 表示只在已过期时提示。",
    fallbackProxy: "失败回退代理",
    fallbackProxyHint: "代理过期后，使用该代理的账号会自动切换到此代理。",
    fallbackProxyShort: "回退 #{id}",
    noFallback: "不自动回退",
    expired: "已过期",
    expiringSoon: "即将到期",
    expiryActive: "有效",
