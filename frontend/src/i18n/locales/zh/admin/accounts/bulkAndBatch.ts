export default {
    ...
    batchTest: {
        ...
        targetCurrentPreview: "一键检测当前预览条件：共 {count} 个账号（不限当前分页）",
        targetAllPlatforms: "一键检测全部平台：共 {count} 个账号（保留其他筛选条件）",
        targetResolving: "正在统计检测目标...",
        scopeCurrent: "当前预览",
        scopeAllPlatforms: "全部平台",
        oneClickDetect: "一键检测",
        modelStrategyLabel: "模型策略",
        executionModeLabel: "执行方式",
        concurrencyLabel: "并发数",
        concurrencyHint: "后端限制 1-10；顺序模式固定为 1。",
        resolveTargetsFailed: "统计检测目标失败，请稍后重试",
        ...
        executionModes: {
            sequential: "顺序检测",
            sequentialHint: "按账号顺序逐个探测，适合排查具体异常。",
            concurrent: "并发检测",
            concurrentHint: "按设定并发探测，适合快速扫完整个平台。",
        },
        run: "开始批量测试",
        ...
        summary: {
            ...
            needsReauth: "需重授权 {count} 个",
        },
        reauthDeadline: "重授权截止：{deadline}",
        columns: {
            account: "账号",
            platform: "平台",
            model: "实际模型",
    ...
    blacklist: {
        ...
        retestRun: "开始复测",
        restoreConfirm: "确定将黑名单账号 '{name}' 拉回正常吗？",
        restoreSuccess: "账号已拉回正常",
        restoreFailed: "拉回正常失败",
        batchRestoreConfirm: "确定将选中的 {count} 个黑名单账号拉回正常吗？",
        batchRestoreSuccess: "已成功拉回 {count} 个账号",
        batchRestorePartial: "部分账号已拉回：成功 {success} 个，失败 {failed} 个",
        batchRestoreFailed: "批量拉回正常失败",
