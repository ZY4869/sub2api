export default {
    ...
    sendingTestMessage: '发送测试消息："Output exactly: OK"',
    ...
    testModel: "测试模型",
    testPrompt: '提示词："Output exactly: OK"',
    textTestPromptLabel: "文本测试提示词",
    textTestPromptPlaceholder: "例如：Output exactly: OK",
    textTestPromptDefault: "Output exactly: OK",
    textTestHint: "选择文本模型后，这里会将提示词直接透传到账号测试请求中。",
