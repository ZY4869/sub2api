export default {
    ...
    duplicateAccountSuccess: "账号已复制",
    duplicateAccountFailed: "复制账号失败",
    restoreOriginalProxy: "回切原代理",
    restoreOriginalProxySuccess: "已回切到原代理：{name}",
    restoreOriginalProxyFailed: "回切原代理失败",
    quotaLimit: "账号额度限制",
