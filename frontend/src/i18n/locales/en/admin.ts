  ...
  admin: {
    ...
    accounts: {
      ...
      protocolGateway: {
        ...
        probeHint: 'Probe the upstream model list and preselect every detected model. Missing models will be added to the local registry after the account is created.',
        probeAction: 'Probe And Fetch Models',
        probeSourceLabel: 'Probe source: ',
        probeNoticeLabel: 'Probe note: ',
        probeSelectionHint: 'Click cards to adjust which probed models should be fetched for this account.',
      ...
      apiKeyProbe: {
        ...
        hint: 'Load upstream models, select the ones you want, and edit alias names directly. Clearing an alias stays blank until submit.',
        action: 'Probe Models',
        ...
        selectionHint: 'Selected models will be saved into this account mapping',
