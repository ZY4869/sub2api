  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        archiveCurrentGroup: 'Archive Current Group',
        archiveCurrentGroupTitle: 'Archive Current Group',
        archiveCurrentGroupDescription: 'This will archive every account in the current group {group} into the archive group and hide them from the main accounts view, regardless of pagination or row selection.',
        archiveCurrentGroupDisabled: 'Select a concrete group in the filters first',
        archiveCurrentGroupSuccess: 'Archived {count} account(s) from {group} into {archive}',
