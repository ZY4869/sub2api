export default {
  admin: {
    ...
    accounts: {
      ...
      batchCreateArchiveNotice: 'Archive mode creates accounts as inactive immediately and binds them only to the archive group. Regular groups and auto model import are ignored.',
      batchCreateArchiveGroupsDisabled: 'Archive mode is enabled, so regular group binding is disabled for this batch.',
      batchCreateAutoImportDisabledHint: 'Archived accounts stay inactive, so auto model import is disabled.',
      ...
      bulkActions: {
        ...
        archiveDescription: 'This will set the selected {count} account(s) to inactive and bind them only to an archive group for easier status/group/search management.',
        archiveCurrentGroup: 'Archive Current Group',
        archiveCurrentGroupTitle: 'Archive Current Group',
        archiveCurrentGroupDescription: 'This will set every account in the current group {group} to inactive and move them into the archive group, regardless of pagination or row selection.',
