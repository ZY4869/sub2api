export default {
    ...
    expiresAtHint: "Leave empty for no expiry. The server stores it in UTC.",
    expiryRemindDays: "Reminder Days",
    expiryRemindDaysHint: "0 only marks proxies after they expire.",
    fallbackProxy: "Fallback Proxy",
    fallbackProxyHint: "Accounts using an expired proxy switch to this proxy.",
    fallbackProxyShort: "Fallback #{id}",
    noFallback: "No automatic fallback",
    expired: "Expired",
