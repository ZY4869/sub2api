export default {
    ...
    openaiFastPolicy: {
        ...
        userIdsHint: "Search and select users or enter IDs manually. Saved values are merged, deduplicated, and invalid IDs are ignored. Leave empty for a global rule.",
