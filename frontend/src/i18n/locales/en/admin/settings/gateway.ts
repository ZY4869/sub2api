export default {
    ...
    scheduling: {
        ...
        openaiAdvancedEnabled: "Enable OpenAI advanced scheduling",
        openaiAdvancedEnabledHint: "Score OpenAI accounts with weighted priority, load, queue, and sticky signals; disable to fall back to basic load-aware scheduling.",
        stickyWeighted: "Sticky weighting",
        stickyWeightedHint: "Adds sticky weight when a session can reuse its previous account, reducing context churn.",
        subscriptionPriority: "Subscription priority",
        subscriptionPriorityHint: "When subscription and non-subscription accounts are both available, try subscription accounts first.",
        lbTopK: "Load balance Top K",
        lbTopKHint: "Leave blank to use the configured default. Smaller values favor top-scored accounts; larger values spread traffic more.",
        ...
        weightPreviousResponse: "Previous response weight",
        weightSessionSticky: "Session sticky weight",
        weightsHint: "Leave blank to use the current effective default. Base weights cannot all be 0.",
    },
    maintenance: {
    ...
    openaiFastPolicy: {
        ...
        userIds: "User IDs",
        userIdsPlaceholder: "One user ID per line (comma/newline separated)",
        userIdsHint: "Leave empty for a global rule. When set, the rule only applies to those authenticated users and takes priority over global rules with the same tier/scope.",
