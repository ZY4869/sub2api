export default {
    ...
    sendingTestMessage: 'Sending test message: "Output exactly: OK"',
    ...
    testPrompt: 'Prompt: "Output exactly: OK"',
    textTestPromptLabel: "Text prompt",
    textTestPromptPlaceholder: "Example: Output exactly: OK",
    textTestPromptDefault: "Output exactly: OK",
    textTestHint: "When a text model is selected, this test sends your prompt directly to the account test endpoint.",
