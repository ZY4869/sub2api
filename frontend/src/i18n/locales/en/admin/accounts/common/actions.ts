export default {
    ...
    duplicateAccountSuccess: "Account duplicated",
    duplicateAccountFailed: "Failed to duplicate account",
    restoreOriginalProxy: "Restore Original Proxy",
    restoreOriginalProxySuccess: "Restored original proxy: {name}",
    restoreOriginalProxyFailed: "Failed to restore original proxy",
