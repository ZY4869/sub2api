export default {
    ...
    requestHeadersInvalidName: "Request header names may only contain valid HTTP token characters.",
    requestHeadersForbiddenName: "This request header cannot be overridden.",
    ...
    poolMode: "Pool Mode",
    poolModeHint: "Enable when the upstream is an API Key account pool; errors won't mark local account status",
    poolModeInfo: "When enabled, common 401/403/429 errors will retry on the same account without marking it rate-limited or errored. Works for Anthropic, OpenAI, and other API Key upstream pools.",
    ...
    poolModeRetryStatusCodesPlaceholder: "401, 403, 429",
    poolModeRetryStatusCodesHint: "Only these HTTP status codes retry on the same account. Empty or invalid values fall back to 401, 403, and 429. Add 5xx codes manually if your upstream pool mainly returns them.",
    ...
    autoRenewEnabled: "Account Auto Renew",
    autoRenewToggle: "Extend on expiry",
    autoRenewHint: "When enabled, the expiry service extends from the original expiration by one period. It will not restore manually disabled or errored accounts.",
    autoRenewPeriod: "Renewal Period",
    autoRenewPeriodHint: "Each run renews at most one period from the original expiration date.",
    autoRenewRequiresExpiration: "Set an expiration time before enabling auto renew.",
    autoRenewPeriodMonth: "Monthly",
    autoRenewPeriodQuarter: "Quarterly",
    autoRenewPeriodYear: "Yearly",
    expired: "Expired",
    proxy: "Proxy",
    noProxy: "No Proxy",
    accountTier: {
        label: "Account tier",
        hint: "The tier is saved in account extra data and can quickly apply default capacity on create or import.",
        applyCapacity: "Apply capacity",
        capacityHint: "Default capacity for this tier: {capacity}",
        options: {
            pro_20x: "Pro 20x ({capacity})",
            pro_5x: "Pro 5x ({capacity})",
            plus: "Plus ({capacity})",
            team: "Team ({capacity})",
            free: "Free ({capacity})",
            max_20x: "Max 20x ({capacity})",
            max_5x: "Max 5x ({capacity})",
            pro: "Pro ({capacity})",
        },
    },
    ...
    expirationQuickWeek: "7 Days",
    expirationQuickMonth: "1 Month",
    expirationQuickYear: "1 Year",
    expiresAtPreview: "Will expire at {value}",
    expiryProbeExtensionDays: "Expiry probe extension days",
    expiryProbeExtensionDaysHint: "If the account still works after expiry self-check, extend the expiration by this many days automatically.",
    expiryProbeExtensionQuick1d: "Extend 1 day",
    expiryProbeExtensionQuick7d: "Extend 7 days",
    ...
    creating: "Creating...",
    updating: "Updating...",
    accountCreated: "Account saved. Run Probe/Test manually if you need model detection or connectivity checks.",
    autoImportModels: "Manually import models right after create",
    ...
    accountUpdated: "Account saved. Run Probe/Test manually if you need model detection or connectivity checks.",
    failedToCreate: "Failed to create account",
    failedToUpdate: "Failed to update account",
    invalidBaseUrl: "Save failed: Base URL violates the current outbound security policy (ACCOUNT_INVALID_BASE_URL).",
    upstreamRedirectBlockedHint: "Upstream redirects are blocked. Use the final HTTPS endpoint directly.",
    ...
    grokOauth: {
        ...
        description: "Use an xAI authorization link or a Sub2api device code to sign in. The local backend exchanges the token and creates the Grok OAuth account with this form's settings.",
        callbackMode: "Browser Callback",
        deviceMode: "Device Code",
        generate: "Generate Auth Link",
        regenerate: "Regenerate",
        openAuthUrl: "Open Auth Page",
        copyAuthUrl: "Copy Auth Link",
        authUrl: "Authorization URL",
        redirectUri: "Redirect URI",
        oauthState: "OAuth State",
        callbackUrl: "Callback URL or Auth Code",
        callbackPlaceholder: "Paste http://127.0.0.1:56121/callback?code=...&state=..., or paste only the code",
        callbackHint: "If the browser cannot load the local callback page, copy the full address bar URL.",
        parsedCode: "Parsed Code",
        parsedState: "Parsed State",
        generateFailed: "Failed to generate Grok authorization URL",
        exchangeFailed: "Grok authorization failed. Generate a new link and try again.",
        sessionMissing: "Generate a Grok authorization link first",
        codeMissing: "Paste the Grok callback URL or code",
        accessTokenMissing: "Grok OAuth did not return an access_token",
        externalDeviceCodeHint: "Generate a device code in Sub2api first; external Grok Build short codes cannot be exchanged by Sub2api.",
        deviceStart: "Generate Device Code",
        deviceRegenerate: "Regenerate Device Code",
        openDeviceUrl: "Open Verification Page",
        copyDeviceCode: "Copy Code",
        deviceUserCode: "Device Code",
        deviceUrl: "Verification URL",
        deviceExpiresIn: "Time Left",
        deviceStarted: "Device code generated. Finish login on the xAI verification page.",
        deviceStartFailed: "Failed to generate Grok device code",
        devicePollFailed: "Failed to check Grok device authorization status",
        devicePending: "Grok device authorization is still pending.",
        deviceSlowDown: "Polling was too frequent, so the xAI interval has been applied.",
        deviceDenied: "Grok device authorization was denied. Generate a new device code.",
        deviceExpired: "Grok device code expired. Generate a new device code.",
        devicePollingHint: "Automatically checks every {seconds}s. You can also confirm manually.",
    },
    ...
    openaiPlanTypeOverride: "OpenAI plan type",
    openaiPlanTypeOverridePlaceholder: "For example plus, pro, team",
    openaiPlanTypeOverrideHint: "Only applies to OpenAI OAuth accounts. Leave empty to remove the manual override and use account-reported capabilities.",
