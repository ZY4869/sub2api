export default {
    ...
    grokOauth: {
        ...
        description: "Generate the xAI authorization link, finish login, then paste the callback URL or authorization code. The local backend exchanges the token and creates the Grok OAuth account with this form's settings.",
