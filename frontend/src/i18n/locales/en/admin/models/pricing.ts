export default {
    pricing: {
        ...
        official: "Official",
        saleOverride: "Legacy Sale Override",
        sale: "Legacy Sale",
    },
    editor: {
        ...
        saleTitle: "Legacy Sale Pricing",
        saleDescription: "This field remains for legacy API compatibility. Configure new customer-facing sale prices per public entry on the Public Catalog page.",
