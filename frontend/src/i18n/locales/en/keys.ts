export default {
  keys: {
    ...
    modelScopeRequiredHint: 'This account must bind API keys to specific models. Select at least one visible model.',
    ...
    modelSelectionRequired: 'Select at least one visible model in this group before saving.',
