...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      default_api_key_model_binding_mode: form.default_api_key_model_binding_mode,
      ...
      usage_ip_geo_enabled: form.usage_ip_geo_enabled,
      usage_ip_geo_provider_url: form.usage_ip_geo_provider_url,
      usage_ip_geo_timeout_ms: form.usage_ip_geo_timeout_ms,
      ...
      payment_subscription_usd_to_cny_rate: form.payment_subscription_usd_to_cny_rate,
      billing_currency_conversion_enabled: form.billing_currency_conversion_enabled,
      billing_currency_cny_to_usd_rate: form.billing_currency_cny_to_usd_rate,
      billing_currency_usd_to_cny_rate: form.billing_currency_usd_to_cny_rate,
      ...
      openai_advanced_scheduler_lb_top_k: form.openai_advanced_scheduler_lb_top_k.trim(),
      openai_advanced_scheduler_weight_priority:
        form.openai_advanced_scheduler_weight_priority.trim(),
      openai_advanced_scheduler_weight_load: form.openai_advanced_scheduler_weight_load.trim(),
      openai_advanced_scheduler_weight_queue: form.openai_advanced_scheduler_weight_queue.trim(),
      openai_advanced_scheduler_weight_error_rate:
        form.openai_advanced_scheduler_weight_error_rate.trim(),
      openai_advanced_scheduler_weight_ttft: form.openai_advanced_scheduler_weight_ttft.trim(),
      openai_advanced_scheduler_weight_quota_headroom:
