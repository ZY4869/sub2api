...
import RequestDetailsBreakdownChart from './components/RequestDetailsBreakdownChart.vue'
import RequestDetailsDrawer from './components/RequestDetailsDrawer.vue'
import RequestDetailsFilterPanel from './components/RequestDetailsFilterPanel.vue'
import RequestDetailsSummaryCards from './components/RequestDetailsSummaryCards.vue'
import RequestDetailsTable from './components/RequestDetailsTable.vue'
import RequestDetailsTrendChart from './components/RequestDetailsTrendChart.vue'
import {
...
function syncRouteQuery() {
  ...
  syncRouteTimer = setTimeout(async () => {
    syncingRoute = true
    try {
      await router.replace({ query: buildRequestTraceQuery(filters.value) })
    } finally {
      syncingRoute = false
    }
  }, 200)
