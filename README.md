...
- 当前默认支持的官方路径：`/v1/models`、`/v1alpha/authTokens`、`/v1beta/fileSearchStores/...`、`/upload/v1beta/files`、`/upload/v1beta/fileSearchStores/...`
- 仍保留一个过渡版本的 deprecated alias：`/v1beta/live/auth-token`、`/v1beta/live/auth-tokens`、`/v1beta/documents`、`/v1beta/operations`
- 当前明确不支持的方法：`generateText`、`generateMessage`、`predict`、`predictLongRunning`
